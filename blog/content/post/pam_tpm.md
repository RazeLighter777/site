...
Moreover, on many Linux distributions, the PAM_AUTHTOK, the **plaintext password** passed through PAM, is reused after the pam_authenticate flow in the pam_open_session flow, where it can be used to decrypt keyrings, mount encrypted partitions, and more. This requires making your keyring password _your actual PIN_. Might as well base64 your keyring at that point.
